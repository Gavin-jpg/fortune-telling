...
const CITY_DATA = {
    ...
    '河北省': {
        ...
        cities: {
            ...
            '保定市': ['竞秀区', '莲池区', '满城区', '清苑区', '徐水区', '涞水县', '阜平县', '徐水县', '定兴县', '唐县', '高阳县', '容城县', '涞源县', '望都县', '安新县', '易县', '曲阳县', '蠡县', '顺平县', '博野县', '雄县', '涿州市', '安国市', '高碑店市'],
    ...
    '山东省': {
        ...
        cities: {
            ...
            '威海市': ['环翠区', '文登区', '荣成市', '乳山市'],
            '日照市': ['东港区', '岚山区', '五莲县', '莒县'],
            '临沂市': ['兰山区', '罗庄区', '河东区', '沂南县', '郯城县', '兰陵县', '费县', '平邑县', '莒南县', '蒙阴县', '临沭县'],
    ...
    '广东省': {
        ...
        cities: {
            ...
            '东莞市': ['东城区', '南城区', '莞城区', '万江区', '石碣镇', '石龙镇', '茶山镇', '石排镇', '企石镇', '横沥镇', '桥头镇', '谢岗镇', '东坑镇', '常平镇', '寮步镇', '樟木头镇', '大朗镇', '黄江镇', '清溪镇', '塘厦镇', '凤岗镇', '大岭山镇', '长安镇', '虎门镇', '厚街镇', '沙田镇', '道滘镇', '洪梅镇', '麻涌镇', '望牛墩镇', '中堂镇', '高埗镇'],
            '中山市': ['石岐区', '东区', '西区', '南区', '五桂山', '港口镇', '三角镇', '民众镇', '南朗镇', '南头镇', '东凤镇', '东升镇', '古镇镇', '沙溪镇', '坦洲镇', '横栏镇', '三乡镇', '板芙镇', '神湾镇', '大涌镇', '黄圃镇', '阜沙镇', '小榄镇'],
            '潮州市': ['湘桥区', '潮安区', '饶平县'],
    ...
    '青海省': {
        name: '青海省',
        cities: {
            '西宁市': ['城中区', '城东区', '城西区', '城北区', '大通回族土族自治县', '湟中县', '湟源县'],
